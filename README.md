...
## 🆕 NY DATOR? Installera OpenModelica ORC-projekt

**Om du ska installera projektet på en ny dator, börja här:**
👉 **[NY_DATOR.md](NY_DATOR.md)** - Steg-för-steg guide för installation från början

**OpenModelica ORC-simulering:**
📂 Se [OpenModelica_ORC/README.md](OpenModelica_ORC/README.md) för komplett dokumentation av ORC-simuleringsprojektet.
